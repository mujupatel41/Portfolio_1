import ProfilePic from "../assets/MujuPatelProfile.jpg"
            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                <div className="w-full lg:w-1/2">
                    <div className="flex justify-center lg:p-8">
                        <motion.img src={ProfilePic} alt="Muju Patel" 
                ...
                <div className="w-full lg:w-1/2">
                    <motion.div className="flex flex-col items-center lg:items-start mt-10"
                        ...
                        <motion.a href="../public/resume.pdf" target="_blank" 
                            variants={childVariants}
                            rel="noopener noreferrer" download 
                            className="bg-white rounded-full p-4
                            text-sm text-stone-800 mb-10">Download Resume</motion.a>
                    </motion.div>
                </div>
            </div>
        </div>
